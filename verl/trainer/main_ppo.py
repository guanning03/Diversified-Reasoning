...
class TaskRunner:
    def run(self, config):
        ...
        train_dataset = create_rl_dataset(config.data.train_files, config.data, tokenizer, processor, split="train")
        val_dataset = create_rl_dataset(config.data.val_files, config.data, tokenizer, processor, split="val")
...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, split="val"):
    """Create a dataset.
